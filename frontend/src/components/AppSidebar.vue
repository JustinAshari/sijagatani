...
<template>
  <aside class="sidebar" :class="{ collapsed: !open }">
    ...
    <nav class="sidebar-nav">
      ...
      <RouterLink v-if="authStore.canAccessPetani" to="/transaksi-petani" class="sidebar-link">
        <span class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <span class="label">Transaksi Petani</span>
      </RouterLink>
      ...
      <RouterLink v-if="authStore.canManageSubAdmins" to="/sub-admins" class="sidebar-link">
        <span class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <span class="label">Kelola Sub-Admin</span>
      </RouterLink>
      ...
      <RouterLink v-if="authStore.canAccessUsers" to="/activity-log" class="sidebar-link">
        <span class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
            <polyline points="14 2 14 8 20 8"/>
