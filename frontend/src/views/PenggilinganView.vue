<template>
  <div class="penggilingan-container">
    <div class="header">
      ...
      <button v-if="authStore.isAdmin" @click="showModal = true" class="btn-add">
        ...
        <tbody>
          ...
          <tr v-else v-for="(item, index) in filteredData" :key="item.id">
            ...
            <td class="action-buttons">
              ...
              <button v-if="authStore.isAdmin" @click="editItem(item)" class="btn-edit" title="Edit">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                </svg>
              </button>
              <button v-if="authStore.isAdmin" @click="deleteItem(item.id)" class="btn-delete" title="Hapus">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
