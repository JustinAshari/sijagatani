<template>
  <div class="penggilingan-container">
    <div class="header">
      ...
      <button v-if="authStore.isAdmin || authStore.isSuperAdmin" @click="showModal = true" class="btn-add">
        ...
        <tbody>
          ...
          <tr v-else v-for="(item, index) in filteredData" :key="item.id">
            ...
            <td class="action-buttons">
              ...
              <button v-if="authStore.isAdmin || authStore.isSuperAdmin" @click="deleteItem(item.id)" class="btn-delete" title="Hapus">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
